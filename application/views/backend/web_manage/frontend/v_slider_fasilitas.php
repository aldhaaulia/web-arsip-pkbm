...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Slider Fasilitas</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Slider Fasilitas</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
				...
				<div class="col-lg-12">
					...
					<div class="card card-primary card-outline">
						<div class="card-header">
							<h5 class="card-title">List Slider Fasilitas</h5>
...
<script>
	...
	var tbl_slider = $('#tbl_slider').DataTable({
		...
		"destroy": true,
		ajax: {
			url: base_url + 'backend/web_manage/slider_fasilitas_list',
			type: "POST",
			data: function(data) {
	...
	function save() {
		...
		var link_ = base_url + 'backend/web_manage/slider_fasilitas_save';
		var mdl = $('#md_add');
		var form = $('#frm_add');
	...
	function set_status(data) {
		if (data) {
			var link_ = base_url + 'backend/web_manage/slider_fasilitas_update';
	...
	async function getData(id) {
		var link_ = base_url + 'backend/web_manage/slider_fasilitas_getByid';
		var NewData = new FormData();
		var data;
