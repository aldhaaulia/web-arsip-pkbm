...
if ($setting['is_register_login_open']) {
	$is_register_open = 1;
} else {
	$is_register_open = 0;
}
						...
						<div class="card-body">
							...
							<form class="form" id="frm_web">
								<div class="form-group">
									...
									<input type="text" name="input_school_name" id="input_school_name" class="form-control" value="<?= $setting['app_name']; ?>" readonly>
								</div>
								...
								<!-- <div class="form-group">
									...
									<img class="img-fluid" src="<? //= $setting['app_logo'];
																?>" alt="Image web" style="width:200px;">
									<br>
								...
								<div class="form-group">
									<label for="input_school_register">Pendaftaran</label>
									<select name="input_school_register" id="input_school_register" class="form-control" readonly>
										<option value="1" <?= ($is_register_open == "1" ? "selected" : ""); ?> >Dibuka</option>
										<option value="0" <?= ($is_register_open == "0" ? "selected" : ""); ?> >Ditutup</option>
									</select>
								</div>
...
<script>
	...
	function set_editable(is_edit = false) {
		...
		var input_school_register = $('#input_school_register');
		...
		if (is_edit) {
			...
			input_school_register.attr('readonly', false);
			...
			input_school_register.attr('readonly', true);
