					...
					<div class="card card-primary card-outline">
						...
						<div class="card-body">
							...
							<form class="form" id="frm_berkas">
								...
								<div class="form-group">
									<label for="file_berkas">File Berkas</label>
									<input type="file" name="file_berkas" id="file_berkas" class="form-control" readonly disabled>
									<p class="helper-block">
										*File yang harus diunduh pada saat registrasi<br>
...
<script>
	...
	function set_editable(is_edit = false) {
		...
		if (is_edit) {
			...
			file_berkas.prop('readonly', false);
			...
			file_berkas.prop('readonly', true);
