			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a href="<?= base_url('backend/dokumen/masuk'); ?>">Surat Masuk</a></li>
						...
						<div class="card-body">
							...
							<form class="form-horizontal" id="frm_berkas">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="input_asal_surat" name="input_asal_surat" placeholder="Asal Surat">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="input_kepada" name="input_kepada" placeholder="Kepada">
									</div>
								</div>
...
<script>
	...
	$('#btn_save').on('click', function(e) {
		var link_ = base_url + 'backend/dokumen/masuk/savesurat';
		...
		if (no_surat != '' && asal_surat != '' && jenis_surat != '' && perihal != '' && kepada != '') {
			is_valid = true;
		} else {
			is_valid = false;
		}
