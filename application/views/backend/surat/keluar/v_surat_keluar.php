                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="card-title">Pencarian Surat Keluar</h5>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a class="btn btn-tool" title="Tambah Data" href="<?= base_url('backend/dokumen/keluar/add'); ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table" id="tbl_surat" style="width: 100%;">
                                    <thead>
                                        <tr>
                                        ...
                                        foreach ($surat as $row) : ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="<?= base_url('backend/dokumen/keluar/getbyid/') . $row['id_surat']; ?>" class="btn btn-success"><i class="fa fa-pen"></i></a>
                                                </td>
                                            </tr>
                                        <?php $no++;
                                        endforeach; ?>
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table" id="tbl_disposisi" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th style="text-align: center;">No.</th>
                                            <th style="text-align: center;">No. Surat</th>
...
<script>
    ...
    $('#Upd_surat').click(function() {
        var link_Save = '<?= base_url() . 'backend/dokumen/keluar/savelabel' ?>';
    ...
    $('#btn_multidel').click(function() {
        var link = '<?= base_url() . 'backend/dokumen/keluar/deleteMulti' ?>';
    ...
    function searchSurat() {
        ...
        if (is_valid) {
            $.ajax({
                url: '<?= base_url() . 'backend/dokumen/keluar/search_Surat'; ?>',
                type: 'post',
                datatype: 'json',
                data: {
                    'q': $('#search_surat').val()
